// https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/downtime
...
export class Downtime extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Downtime that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/downtime#import import section} in the documentation of this resource for the id to use
