...
// https://registry.terraform.io/providers/datadog/datadog/3.44.1/docs/data-sources/sensitive_data_scanner_group_order
...
export class DataDatadogSensitiveDataScannerGroupOrder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogSensitiveDataScannerGroupOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.1/docs/data-sources/sensitive_data_scanner_group_order#import import section} in the documentation of this resource for the id to use
