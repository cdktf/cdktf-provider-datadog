...
// https://registry.terraform.io/providers/datadog/datadog/3.65.0/docs/resources/downtime_schedule
...
export class DowntimeSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DowntimeSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.65.0/docs/resources/downtime_schedule#import import section} in the documentation of this resource for the id to use
