...
// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/user_role
...
export class UserRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/user_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/user_role datadog_user_role} Resource
  *
  * @param scope The scope in which to define this construct
