...
// https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric
...
export class SpansMetric extends cdktf.TerraformResource {
  ...
  */
  ...
  private _groupBy = new SpansMetricGroupByList(this, "group_by", false);
  public get groupBy() {
