...
// https://registry.terraform.io/providers/datadog/datadog/3.75.0/docs/resources/team_membership
...
export class TeamMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.75.0/docs/resources/team_membership#import import section} in the documentation of this resource for the id to use
