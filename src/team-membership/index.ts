// https://registry.terraform.io/providers/datadog/datadog/3.48.1/docs/resources/team_membership
...
export class TeamMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.48.1/docs/resources/team_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.48.1/docs/resources/team_membership datadog_team_membership} Resource
  *
  * @param scope The scope in which to define this construct
