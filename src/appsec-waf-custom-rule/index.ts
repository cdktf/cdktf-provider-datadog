...
// https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/resources/appsec_waf_custom_rule
...
export class AppsecWafCustomRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsecWafCustomRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/resources/appsec_waf_custom_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/resources/appsec_waf_custom_rule datadog_appsec_waf_custom_rule} Resource
  *
  * @param scope The scope in which to define this construct
