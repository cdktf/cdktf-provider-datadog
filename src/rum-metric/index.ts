...
// https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/rum_metric
...
export class RumMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/rum_metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/rum_metric datadog_rum_metric} Resource
  *
  * @param scope The scope in which to define this construct
