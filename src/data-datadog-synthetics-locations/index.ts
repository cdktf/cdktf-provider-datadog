// https://registry.terraform.io/providers/datadog/datadog/3.40.0/docs/data-sources/synthetics_locations
...
export class DataDatadogSyntheticsLocations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogSyntheticsLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.40.0/docs/data-sources/synthetics_locations#import import section} in the documentation of this resource for the id to use
