...
// https://registry.terraform.io/providers/datadog/datadog/3.33.0/docs/data-sources/user
...
export class DataDatadogUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.33.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.33.0/docs/data-sources/user datadog_user} Data Source
  *
  * @param scope The scope in which to define this construct
