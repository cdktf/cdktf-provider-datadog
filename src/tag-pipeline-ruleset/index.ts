...
// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/tag_pipeline_ruleset
...
export class TagPipelineRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagPipelineRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/tag_pipeline_ruleset#import import section} in the documentation of this resource for the id to use
