...
// https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/cloud_workload_security_agent_rules
...
export class DataDatadogCloudWorkloadSecurityAgentRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCloudWorkloadSecurityAgentRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/cloud_workload_security_agent_rules#import import section} in the documentation of this resource for the id to use
