// https://registry.terraform.io/providers/datadog/datadog/3.39.0/docs/resources/synthetics_global_variable
...
export class SyntheticsGlobalVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsGlobalVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.39.0/docs/resources/synthetics_global_variable#import import section} in the documentation of this resource for the id to use
