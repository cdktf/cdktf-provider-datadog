...
// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/csm_threats_agent_rule
...
export class CsmThreatsAgentRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsmThreatsAgentRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/csm_threats_agent_rule#import import section} in the documentation of this resource for the id to use
