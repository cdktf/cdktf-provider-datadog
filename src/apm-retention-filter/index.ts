...
// https://registry.terraform.io/providers/datadog/datadog/3.38.0/docs/resources/apm_retention_filter
...
export class ApmRetentionFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmRetentionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.38.0/docs/resources/apm_retention_filter#import import section} in the documentation of this resource for the id to use
