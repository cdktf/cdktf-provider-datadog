...
// https://registry.terraform.io/providers/datadog/datadog/3.76.0/docs/resources/org_connection
...
export class OrgConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.76.0/docs/resources/org_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.76.0/docs/resources/org_connection datadog_org_connection} Resource
  *
  * @param scope The scope in which to define this construct
