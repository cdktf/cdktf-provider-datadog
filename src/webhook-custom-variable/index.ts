// https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/webhook_custom_variable
...
export class WebhookCustomVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebhookCustomVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/webhook_custom_variable#import import section} in the documentation of this resource for the id to use
