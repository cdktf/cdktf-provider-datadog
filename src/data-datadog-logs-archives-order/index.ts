// https://registry.terraform.io/providers/datadog/datadog/3.36.0/docs/data-sources/logs_archives_order
...
export interface DataDatadogLogsArchivesOrderConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.36.0/docs/data-sources/logs_archives_order#id DataDatadogLogsArchivesOrder#id}
  *
...
export class DataDatadogLogsArchivesOrder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogLogsArchivesOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.36.0/docs/data-sources/logs_archives_order#import import section} in the documentation of this resource for the id to use
