// https://www.terraform.io/docs/providers/datadog/d/monitor_config_policies
...
export class DataDatadogMonitorConfigPolicies extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/datadog/d/monitor_config_policies datadog_monitor_config_policies} Data Source
  *
