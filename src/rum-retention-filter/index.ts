// https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/rum_retention_filter
...
export class RumRetentionFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumRetentionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/rum_retention_filter#import import section} in the documentation of this resource for the id to use
