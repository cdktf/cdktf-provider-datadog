...
// https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/resources/integration_aws
...
export class IntegrationAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/resources/integration_aws#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IntegrationAws to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "datadog_integration_aws", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      extended_resource_collection_enabled: cdktf.stringToTerraform(this._extendedResourceCollectionEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      extended_resource_collection_enabled: {
        value: cdktf.stringToHclTerraform(this._extendedResourceCollectionEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
