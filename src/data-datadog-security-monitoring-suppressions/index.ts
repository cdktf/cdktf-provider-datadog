// https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/data-sources/security_monitoring_suppressions
...
export class DataDatadogSecurityMonitoringSuppressions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogSecurityMonitoringSuppressions that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.62.0/docs/data-sources/security_monitoring_suppressions#import import section} in the documentation of this resource for the id to use
