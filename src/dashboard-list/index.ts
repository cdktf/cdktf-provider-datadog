...
// https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list
...
export interface DashboardListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list#name DashboardList#name}
  */
  readonly name: string;
  /**
  * dash_item block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list#dash_item DashboardList#dash_item}
  */
...
export interface DashboardListDashItem {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list#dash_id DashboardList#dash_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list#type DashboardList#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list datadog_dashboard_list}
*/
export class DashboardList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DashboardList that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/dashboard_list datadog_dashboard_list} Resource
  *
  * @param scope The scope in which to define this construct
