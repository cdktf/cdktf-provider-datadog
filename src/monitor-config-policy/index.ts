...
// https://registry.terraform.io/providers/datadog/datadog/3.75.0/docs/resources/monitor_config_policy
...
export class MonitorConfigPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorConfigPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.75.0/docs/resources/monitor_config_policy#import import section} in the documentation of this resource for the id to use
