...
Refer to the Terraform Registory for docs: [`datadog_authn_mapping`](https://registry.terraform.io/providers/datadog/datadog/3.30.0/docs/resources/authn_mapping).
...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/authnmapping"
...
| <code><a href="#@cdktf/provider-datadog.authnMapping.AuthnMappingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.30.0/docs/resources/authn_mapping#id AuthnMapping#id}. |
