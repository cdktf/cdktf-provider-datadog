...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v5/monitor"
...
&monitor.MonitorConfig {
	...
	Locked: interface{},
	MonitorThresholds: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.monitor.MonitorMonitorThresholds,
	MonitorThresholdWindows: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.monitor.MonitorMonitorThresholdWindows,
	NewGroupDelay: *f64,
	NewHostDelay: *f64,
	NoDataTimeframe: *f64,
	...
	TimeoutH: *f64,
	Validate: interface{},
	Variables: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.monitor.MonitorVariables,
}
```
...
&monitor.MonitorVariablesEventQueryGroupBy {
	Facet: *string,
	Limit: *f64,
	Sort: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.monitor.MonitorVariablesEventQueryGroupBySort,
}
```
