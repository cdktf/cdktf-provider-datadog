...
```typescript
public resetOverrideUiDefinedResources(): void
```
...
| <code><a href="#@cdktf/provider-datadog.customAllocationRules.CustomAllocationRules.property.overrideUiDefinedResourcesInput">overrideUiDefinedResourcesInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-datadog.customAllocationRules.CustomAllocationRules.property.overrideUiDefinedResources">overrideUiDefinedResources</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly overrideUiDefinedResourcesInput: boolean | IResolvable;
```
...
```typescript
public readonly overrideUiDefinedResources: boolean | IResolvable;
```
...
| <code><a href="#@cdktf/provider-datadog.customAllocationRules.CustomAllocationRulesConfig.property.overrideUiDefinedResources">overrideUiDefinedResources</a></code> | <code>boolean \| cdktf.IResolvable</code> | Whether to override UI-defined rules. |
