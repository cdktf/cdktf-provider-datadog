...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v8/applicationkey"
...
| <code><a href="#@cdktf/provider-datadog.applicationKey.ApplicationKeyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/application_key#id ApplicationKey#id}. |
