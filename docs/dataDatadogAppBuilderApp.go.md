...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/datadatadogappbuilderapp"
...
Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.82.0/docs/data-sources/app_builder_app#import import section} in the documentation of this resource for the id to use
