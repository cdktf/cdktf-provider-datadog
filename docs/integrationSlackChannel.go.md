...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/integrationslackchannel"
...
&integrationslackchannel.IntegrationSlackChannelConfig {
	...
	AccountName: *string,
	ChannelName: *string,
	Display: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.integrationSlackChannel.IntegrationSlackChannelDisplay,
	Id: *string,
}
```
