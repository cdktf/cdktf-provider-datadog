...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/integrationslackchannel"
...
&integrationslackchannel.IntegrationSlackChannelConfig {
	...
	AccountName: *string,
	ChannelName: *string,
	Display: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.integrationSlackChannel.IntegrationSlackChannelDisplay,
	Id: *string,
}
```
