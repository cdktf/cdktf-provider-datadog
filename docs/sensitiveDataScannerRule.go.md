...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/sensitivedatascannerrule"
...
&sensitivedatascannerrule.SensitiveDataScannerRuleConfig {
	...
	Tags: *[]*string,
	TextReplacement: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacement,
}
```
