...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v8/sensitivedatascannerrule"
...
&sensitivedatascannerrule.SensitiveDataScannerRuleConfig {
	...
	Tags: *[]*string,
	TextReplacement: github.com/cdktf/cdktf-provider-datadog-go/datadog/v8.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacement,
}
```
