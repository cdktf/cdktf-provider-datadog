...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/sensitivedatascannerrule"
...
&sensitivedatascannerrule.SensitiveDataScannerRuleConfig {
	...
	Tags: *[]*string,
	TextReplacement: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacement,
}
```
