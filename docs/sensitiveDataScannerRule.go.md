...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/sensitivedatascannerrule"
...
&sensitivedatascannerrule.SensitiveDataScannerRuleConfig {
	...
	Id: *string,
	IncludedKeywordConfiguration: github.com/cdktf/cdktf-provider-datadog-go/datadog/v12.sensitiveDataScannerRule.SensitiveDataScannerRuleIncludedKeywordConfiguration,
	IsEnabled: interface{},
	Name: *string,
	Namespaces: *[]*string,
	Pattern: *string,
	...
	Tags: *[]*string,
	TextReplacement: github.com/cdktf/cdktf-provider-datadog-go/datadog/v12.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacement,
}
```
...
| <code><a href="#@cdktf/provider-datadog.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacement.property.shouldSaveMatch">ShouldSaveMatch</a></code> | <code>interface{}</code> | Only valid when type == `replacement_string`. |
...
| <code><a href="#@cdktf/provider-datadog.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacementOutputReference.property.shouldSaveMatchInput">ShouldSaveMatchInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-datadog.sensitiveDataScannerRule.SensitiveDataScannerRuleTextReplacementOutputReference.property.shouldSaveMatch">ShouldSaveMatch</a></code> | <code>interface{}</code> | *No description.* |
