...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/rummetric"
...
&rummetric.RumMetricConfig {
	...
	EventType: *string,
	Name: *string,
	Compute: github.com/cdktf/cdktf-provider-datadog-go/datadog/v12.rumMetric.RumMetricCompute,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v12.rumMetric.RumMetricFilter,
	GroupBy: interface{},
	Uniqueness: github.com/cdktf/cdktf-provider-datadog-go/datadog/v12.rumMetric.RumMetricUniqueness,
}
```
