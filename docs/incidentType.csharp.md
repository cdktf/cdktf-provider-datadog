...
| <code><a href="#@cdktf/provider-datadog.incidentType.IncidentTypeConfig.property.isDefault">IsDefault</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | Whether this incident type is the default type. |
