...
Refer to the Terraform Registory for docs: [`data_datadog_service_account`](https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/data-sources/service_account).
...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v8/datadatadogserviceaccount"
