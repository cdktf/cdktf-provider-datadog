...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/metricmetadata"
...
| <code><a href="#@cdktf/provider-datadog.metricMetadata.MetricMetadataConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/metric_metadata#id MetricMetadata#id}. |
