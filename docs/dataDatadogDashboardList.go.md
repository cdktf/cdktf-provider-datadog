...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/datadatadogdashboardlist"
...
| <code><a href="#@cdktf/provider-datadog.dataDatadogDashboardList.DataDatadogDashboardListConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/data-sources/dashboard_list#id DataDatadogDashboardList#id}. |
