...
Refer to the Terraform Registory for docs: [`datadog_synthetics_concurrency_cap`](https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/synthetics_concurrency_cap).
...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v6/syntheticsconcurrencycap"
