...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/downtimeschedule"
...
&downtimeschedule.DowntimeScheduleConfig {
	...
	Message: *string,
	MonitorIdentifier: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.downtimeSchedule.DowntimeScheduleMonitorIdentifier,
	MuteFirstRecoveryNotification: interface{},
	NotifyEndStates: *[]*string,
	NotifyEndTypes: *[]*string,
	OneTimeSchedule: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.downtimeSchedule.DowntimeScheduleOneTimeSchedule,
	RecurringSchedule: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.downtimeSchedule.DowntimeScheduleRecurringSchedule,
}
```
