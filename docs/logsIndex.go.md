...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/logsindex"
...
&logsindex.LogsIndexConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsIndex.LogsIndexFilter,
	Name: *string,
	DailyLimit: *f64,
