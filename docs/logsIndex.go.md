...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v5/logsindex"
...
&logsindex.LogsIndexConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.logsIndex.LogsIndexFilter,
	Name: *string,
	DailyLimit: *f64,
