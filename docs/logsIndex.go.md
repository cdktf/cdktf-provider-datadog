...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/logsindex"
...
&logsindex.LogsIndexConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.logsIndex.LogsIndexFilter,
	Name: *string,
	DailyLimit: *f64,
