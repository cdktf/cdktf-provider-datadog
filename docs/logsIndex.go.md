...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v8/logsindex"
...
&logsindex.LogsIndexConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v8.logsIndex.LogsIndexFilter,
	Name: *string,
	DailyLimit: *f64,
