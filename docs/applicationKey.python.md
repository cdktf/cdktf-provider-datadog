...
| <code><a href="#@cdktf/provider-datadog.applicationKey.ApplicationKey.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.32.0/docs/resources/application_key#id ApplicationKey#id}. |
...
| <code><a href="#@cdktf/provider-datadog.applicationKey.ApplicationKey.resetId">reset_id</a></code> | *No description.* |
...
##### `reset_id` <a name="reset_id" id="@cdktf/provider-datadog.applicationKey.ApplicationKey.resetId"></a>
...
| <code><a href="#@cdktf/provider-datadog.applicationKey.ApplicationKey.property.idInput">id_input</a></code> | <code>str</code> | *No description.* |
...
##### `id_input`<sup>Optional</sup> <a name="id_input" id="@cdktf/provider-datadog.applicationKey.ApplicationKey.property.idInput"></a>
...
| <code><a href="#@cdktf/provider-datadog.applicationKey.ApplicationKeyConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.32.0/docs/resources/application_key#id ApplicationKey#id}. |
