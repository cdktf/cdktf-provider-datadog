...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/syntheticsprivatelocation"
...
&syntheticsprivatelocation.SyntheticsPrivateLocationConfig {
	...
	Description: *string,
	Id: *string,
	Metadata: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.syntheticsPrivateLocation.SyntheticsPrivateLocationMetadata,
	Tags: *[]*string,
}
```
