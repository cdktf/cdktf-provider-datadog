...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/syntheticsprivatelocation"
...
&syntheticsprivatelocation.SyntheticsPrivateLocationConfig {
	...
	Description: *string,
	Id: *string,
	Metadata: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.syntheticsPrivateLocation.SyntheticsPrivateLocationMetadata,
	Tags: *[]*string,
}
```
