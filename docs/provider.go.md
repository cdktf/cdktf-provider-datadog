...
&provider.DatadogProviderConfig {
	...
	ApiUrl: *string,
	AppKey: *string,
	DefaultTags: github.com/cdktf/cdktf-provider-datadog-go/datadog.provider.DatadogProviderDefaultTags,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-datadog.provider.DatadogProviderDefaultTags.property.tags">Tags</a></code> | <code>*map[string]*string</code> | [Experimental - Monitors and Logs Pipelines only] Resource tags to be applied by default across all resources. |
