...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v5/organizationsettings"
...
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettings.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&organizationsettings.OrganizationSettingsConfig {
	...
	Id: *string,
	Name: *string,
	Settings: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.organizationSettings.OrganizationSettingsSettings,
}
```
...
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&organizationsettings.OrganizationSettingsSettings {
	Saml: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.organizationSettings.OrganizationSettingsSettingsSaml,
	SamlAutocreateUsersDomains: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.organizationSettings.OrganizationSettingsSettingsSamlAutocreateUsersDomains,
	SamlIdpInitiatedLogin: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.organizationSettings.OrganizationSettingsSettingsSamlIdpInitiatedLogin,
	SamlStrictMode: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.organizationSettings.OrganizationSettingsSettingsSamlStrictMode,
...
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsSettings.property.privateWidgetShare">PrivateWidgetShare</a></code> | <code>interface{}</code> | Whether or not the organization users can share widgets outside of Datadog. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsSettingsSaml.property.enabled">Enabled</a></code> | <code>interface{}</code> | Whether or not SAML is enabled for this organization. |
...
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsSettingsSamlAutocreateUsersDomains.property.enabled">Enabled</a></code> | <code>interface{}</code> | Whether or not the automated user creation based on SAML domain is enabled. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsSettingsSamlIdpInitiatedLogin.property.enabled">Enabled</a></code> | <code>interface{}</code> | Whether or not a SAML identity provider metadata file was provided to the Datadog organization. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-datadog.organizationSettings.OrganizationSettingsSettingsSamlStrictMode.property.enabled">Enabled</a></code> | <code>interface{}</code> | Whether or not the SAML strict mode is enabled. If true, all users must log in with SAML. |
