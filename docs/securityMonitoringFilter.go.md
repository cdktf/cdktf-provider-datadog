...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/securitymonitoringfilter"
...
| <code><a href="#@cdktf/provider-datadog.securityMonitoringFilter.SecurityMonitoringFilterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.29.0/docs/resources/security_monitoring_filter#id SecurityMonitoringFilter#id}. |
