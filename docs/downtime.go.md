...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v6/downtime"
...
| <code><a href="#@cdktf/provider-datadog.downtime.Downtime.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&downtime.DowntimeConfig {
	...
	Recurrence: github.com/cdktf/cdktf-provider-datadog-go/datadog/v6.downtime.DowntimeRecurrence,
	Start: *f64,
	StartDate: *string,
	Timezone: *string,
}
...
| <code><a href="#@cdktf/provider-datadog.downtime.DowntimeConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
