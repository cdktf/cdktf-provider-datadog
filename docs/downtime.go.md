...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/downtime"
...
&downtime.DowntimeConfig {
	...
	Recurrence: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.downtime.DowntimeRecurrence,
	Start: *f64,
	StartDate: *string,
	Timezone: *string,
}
