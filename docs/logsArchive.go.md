...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/logsarchive"
...
&logsarchive.LogsArchiveConfig {
	...
	Name: *string,
	Query: *string,
	AzureArchive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsArchive.LogsArchiveAzureArchive,
	GcsArchive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsArchive.LogsArchiveGcsArchive,
	Id: *string,
	IncludeTags: interface{},
	RehydrationMaxScanSizeInGb: *f64,
	RehydrationTags: *[]*string,
	S3Archive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsArchive.LogsArchiveS3Archive,
}
```
