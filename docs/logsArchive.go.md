...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/logsarchive"
...
&logsarchive.LogsArchiveConfig {
	...
	Name: *string,
	Query: *string,
	AzureArchive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.logsArchive.LogsArchiveAzureArchive,
	GcsArchive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.logsArchive.LogsArchiveGcsArchive,
	Id: *string,
	IncludeTags: interface{},
	RehydrationMaxScanSizeInGb: *f64,
	RehydrationTags: *[]*string,
	S3Archive: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.logsArchive.LogsArchiveS3Archive,
}
```
