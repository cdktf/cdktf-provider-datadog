...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v6/spansmetric"
...
&spansmetric.SpansMetricConfig {
	...
	Name: *string,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v6.spansMetric.SpansMetricFilter,
	GroupBy: interface{},
}
```
