...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/spansmetric"
...
&spansmetric.SpansMetricConfig {
	...
	Name: *string,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v7.spansMetric.SpansMetricFilter,
	GroupBy: interface{},
}
```
