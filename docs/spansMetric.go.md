...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v8/spansmetric"
...
&spansmetric.SpansMetricConfig {
	...
	Name: *string,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v8.spansMetric.SpansMetricFilter,
	GroupBy: interface{},
}
```
