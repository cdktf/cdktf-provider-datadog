...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/sensitivedatascannergroup"
...
&sensitivedatascannergroup.SensitiveDataScannerGroupConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.sensitiveDataScannerGroup.SensitiveDataScannerGroupFilter,
	IsEnabled: interface{},
	Name: *string,
	ProductList: *[]*string,
	Description: *string,
