...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/logsmetric"
...
&logsmetric.LogsMetricConfig {
	...
	Compute: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsMetric.LogsMetricCompute,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.logsMetric.LogsMetricFilter,
	Name: *string,
	GroupBy: interface{},
	Id: *string,
}
...
| <code><a href="#@cdktf/provider-datadog.logsMetric.LogsMetricConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.30.0/docs/resources/logs_metric#id LogsMetric#id}. |
