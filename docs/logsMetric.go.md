...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v5/logsmetric"
...
&logsmetric.LogsMetricConfig {
	...
	Compute: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.logsMetric.LogsMetricCompute,
	Filter: github.com/cdktf/cdktf-provider-datadog-go/datadog/v5.logsMetric.LogsMetricFilter,
	Name: *string,
	GroupBy: interface{},
	Id: *string,
}
