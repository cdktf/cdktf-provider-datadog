...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/integrationmsteamsworkflowswebhookhandle"
...
Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.68.0/docs/resources/integration_ms_teams_workflows_webhook_handle#import import section} in the documentation of this resource for the id to use
