...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v7/integrationawstagfilter"
...
| <code><a href="#@cdktf/provider-datadog.integrationAwsTagFilter.IntegrationAwsTagFilterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/integration_aws_tag_filter#id IntegrationAwsTagFilter#id}. |
