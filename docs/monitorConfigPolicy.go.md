...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v9/monitorconfigpolicy"
...
&monitorconfigpolicy.MonitorConfigPolicyConfig {
	...
	PolicyType: *string,
	Id: *string,
	TagPolicy: github.com/cdktf/cdktf-provider-datadog-go/datadog/v9.monitorConfigPolicy.MonitorConfigPolicyTagPolicy,
}
```
