...
```go
import "github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/integrationconfluentaccount"
...
Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/integration_confluent_account#import import section} in the documentation of this resource for the id to use
